...
module.exports = {
  ...
  rules: {
    ...
    'react/jsx-curly-spacing': [2, { "when": "always" }], // ['error', 'never', { allowMultiline: true }]
    ...
    'react/jsx-indent-props': ["error", "tab"], // ['error', 2]
    ...
    'react/jsx-one-expression-per-line': [0], // ['error', { allow: 'single-child' }]
